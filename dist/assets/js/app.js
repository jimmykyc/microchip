...
(()=>{
    var e = {
        755: function(e, t) {
            ...
            !function(t, n) {
                ...
                var $ = function(e) {
                    var t, n, i, o, r, s, a, l, c, d, u, p, f, h, v, g, y, m, w, b = "sizzle" + 1 * new Date, x = e.document, T = 0, k = 0, S = le(), C = le(), $ = le(), A = le(), E = function(e, t) {
                        return e === t && (u = !0),
                        0
                    }, j = {}.hasOwnProperty, D = [], L = D.pop, H = D.push, O = D.push, N = D.slice, q = function(e, t) {
                        for (var n = 0, i = e.length; n < i; n++)
                            if (e[n] === t)
                                return n;
                        return -1
                    }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", I = "(?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", z = "\\[[\\x20\\t\\r\\n\\f]*(" + I + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + M + "*\\]", W = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + z + ")*)|.*)\\)|)", R = new RegExp(M + "+","g"), F = new RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"), B = new RegExp("^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*"), U = new RegExp("^[\\x20\\t\\r\\n\\f]*([>+~]|[\\x20\\t\\r\\n\\f])[\\x20\\t\\r\\n\\f]*"), _ = new RegExp(M + "|>"), X = new RegExp(W), Y = new RegExp("^" + I + "$"), V = {
                        ID: new RegExp("^#(" + I + ")"),
                        CLASS: new RegExp("^\\.(" + I + ")"),
                        TAG: new RegExp("^(" + I + "|[*])"),
                        ATTR: new RegExp("^" + z),
                    ...
                    try {
                        O.apply(D = N.call(x.childNodes), x.childNodes),
                    ...
                    function ae(e, t, i, o) {
                        ...
                        v)) {
                            ...
                            if (n.qsa && !A[e + " "] && (!g || !g.test(e)) && (1 !== x || "object" !== t.nodeName.toLowerCase())) {
                                ...
                                try {
                                    return O.apply(i, m.querySelectorAll(y)),
                                    i
                                } catch (t) {
                                    A(e, !0)
                                } finally {
                            ...
                            CHILD: function(e, t, n, i, o) {
                                ...
                                : function(t, n, l) {
                                    ...
                                    if (g) {
                                        ...
                                        s && m) {
                                            for (w = (f = (c = (d = (u = (p = g)[b] || (p[b] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2],
                                        ...
                                        !1 === w)
                                            for (; (p = ++f && p && p[v] || (w = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++w || (m && ((d = (u = p[b] || (p[b] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [T, w]),
                                            p !== t)); )
                                                ;
                        ...
                        ce((function(r, s, a, l) {
                            var c, d, u, p = [], f = [], h = s.length, v = r || function(e, t, n) {
                                for (var i = 0, o = t.length; i < o; i++)
                                    ae(e, t[i], n);
                                return n
                            }(t || "*", a.nodeType ? [a] : a, []), g = !e || !r && t ? v : Te(v, p, e, a, l), y = n ? o || (r ? e : h || i) ? [] : s : g;
                            if (n && n(g, y, a, l),
                            i)
                                for (c = Te(y, f),
                                i(c, [], a, l),
                            ...
                            a = $(e, function(e, t) {
                                var n = t.length > 0
                                  ...
                                  , r = function(r, s, a, l, d) {
                                    var u, h, g, y = 0, m = "0", w = r && [], b = [], x = c, k = r || o && i.find.TAG("*", d), S = T += null == x ? 1 : Math.random() || .1, C = k.length;
                ...
                S.fn.extend({
                    ...
                    is: function(e) {
                        return !!H(this, "string" == typeof e && j.test(e) ? S(e) : e || [], !1).length
                    }
                });
                var O, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
                (S.fn.init = function(e, t, n) {
                    ...
                    "string" == typeof e) {
                        ...
                        if (i[1]) {
                            ...
                            S.merge(this, S.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : w, !0)),
                ...
                S.each({
                    ...
                    S.fn[e] = function(n, i) {
                        ...
                        this.length > 1 && (P[e] || S.uniqueSort(o),
                        q.test(e) && o.reverse()),
                        this.pushStack(o)
                    }
                }
                          ...
                          , o = {
                            ...
                            then: function(e, n, o) {
                                        ...
                                        var a = this
                                          ...
                                          , c = function() {
                                            ...
                                            if (!(e < r)) {
                                                ...
                                                y(c) ? o ? c.call(i, s(r, t, z, o), s(r, t, W, o)) : (r++,
                                                c.call(i, s(r, t, z, o), s(r, t, W, o), s(r, t, z, t.notifyWith))) : (n !== z && (a = void 0,
                                                l = [i]),
                                                (o || t.resolveWith)(a, l))
                                            }
                                        }
                                ...
                                return S.Deferred((function(i) {
                                    t[0][3].add(s(0, i, y(o) ? o : z, i.notifyWith)),
                                    t[1][3].add(s(0, i, y(e) ? e : z)),
                                    t[2][3].add(s(0, i, y(n) ? n : W))
                                }
                                )).promise()
                            },
                            promise: function(e) {
                ...
                S.extend({
                    ...
                    ready: function(e) {
                        ...
                        !0 !== e && --S.readyWait > 0 || B.resolveWith(w, [S]))
                    }
                }),
                S.ready.then = B.then,
                "complete" === w.readyState || "loading" !== w.readyState && !w.documentElement.doScroll ? i.setTimeout(S.ready) : (w.addEventListener("DOMContentLoaded", U),
                ...
                var he, ve, ge = /^(?:checkbox|radio)$/i, ye = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, me = /^$|^module$|\/(?:java|ecma)script/i;
                ...
                we.th = we.td,
                g.option || (we.optgroup = we.option = [1, "<select multiple='multiple'>", "</select>"]);
                var Te = /<|&#?\w+;/;
                ...
                S.event = {
                        ...
                        if (g && (l = g.events)) {
                            for (c = (t = (t || "").match(I) || [""]).length; c--; )
                                ...
                                f) {
                                    ...
                                    s && !p.length && (u.teardown && !1 !== u.teardown.call(e, h, g.handle) || S.removeEvent(e, f, g.handle),
                                    delete l[f])
                                } else
                                    for (f in l)
                    ...
                    special: {
                        ...
                        click: {
                            setup: function(e) {
                                var t = this || e;
                                return ge.test(t.type) && t.click && D(t, "input") && je(t, "click", Ce),
                                !1
                            },
                            trigger: function(e) {
                                var t = this || e;
                                return ge.test(t.type) && t.click && D(t, "input") && je(t, "click"),
                                !0
                            },
                            _default: function(e) {
                                var t = e.target;
                ...
                function Ie(e, t, n, i) {
                    ...
                    r || i)) {
                        for (a = (s = S.map(be(o, "script"), Ne)).length; u < p; u++)
                            c = o,
                            u !== f && (c = S.clone(c, !0, !0),
                        ...
                        if (a)
                            ...
                            u = 0; u < a; u++)
                                c = s[u],
                                me.test(c.type || "") && !K.access(c, "globalEval") && S.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? S._evalUrl && !c.noModule && S._evalUrl(c.src, {
                ...
                function ze(e, t, n) {
                    for (var i, o = t ? S.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
                        ...
                        i.parentNode && (n && ae(i) && xe(be(i, "script")),
                ...
                function Ue(e, t, n) {
                    ...
                    return (n = n || Re(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ae(e) || (s = S.style(e, t)),
                ...
                !function() {
                    ...
                    var n, o, r, s, a, l, c = w.createElement("div"), d = w.createElement("div");
                ...
                function nt(e, t, n) {
                    ...
                    return (!g.boxSizingReliable() && o || !g.reliableTrDimensions() && D(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === S.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === S.css(e, "boxSizing", !1, i),
                    (r = a in e) && (s = e[a])),
                ...
                S.each(["height", "width"], (function(e, t) {
                    S.cssHooks[t] = {
                        get: function(e, n, i) {
                            if (n)
                                return !Qe.test(S.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? nt(e, t, i) : Fe(e, Ke, (function() {
                                    return nt(e, t, i)
                                }
                                ))
                        },
                        set: function(e, n, i) {
                            var o, r = Re(e), s = !g.scrollboxSize() && "absolute" === r.position, a = (s || i) && "border-box" === S.css(e, "boxSizing", !1, r), l = i ? tt(e, t, i, a, r) : 0;
                ...
                S.cssHooks.marginLeft = _e(g.reliableMarginLeft, (function(e, t) {
                    if (t)
                ...
                function lt() {
                    rt && (!1 === w.hidden && i.requestAnimationFrame ? i.requestAnimationFrame(lt) : i.setTimeout(lt, S.fx.interval),
                    S.fx.tick())
                }
                function ct() {
                ...
                S.Animation = S.extend(pt, {
                    ...
                    prefilters: [function(e, t, n) {
                        var i, o, r, s, a, l, c, d, u = "width"in t || "height"in t, p = this, f = {}, h = e.style, v = e.nodeType && ce(e), g = K.get(e, "fxshow");
                ...
                S.extend(S.event, {
                    trigger: function(e, t, n, o) {
                        var r, s, a, l, c, d, u, p, h = [n || w], v = f.call(e, "type") ? e.type : e, g = f.call(e, "namespace") ? e.namespace.split(".") : [];
                        if (s = p = a = n = n || w,
                        3 !== n.nodeType && 8 !== n.nodeType && !xt.test(v + S.event.triggered) && (v.indexOf(".") > -1 && (g = v.split("."),
                        v = g.shift(),
                        g.sort()),
                        c = v.indexOf(":") < 0 && "on" + v,
                        ...
                        o || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                            ...
                            return e.type = v,
                            o || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), t) || !Q(n) || c && y(n[v]) && !m(n) && ((a = n[c]) && (n[c] = null),
                            S.event.triggered = v,
                ...
                S.fn.extend({
                    ...
                    serializeArray: function() {
                        return this.map((function() {
                            ...
                            var e = this.type;
                            return this.name && !S(this).is(":disabled") && jt.test(this.nodeName) && !Et.test(e) && (this.checked || !ge.test(e))
                        }
                        )).map((function(e, t) {
                            var n = S(this).val();
                ...
                S.extend({
                    ...
                    ajax: function(e, t) {
                        ...
                        e = void 0),
                        t = t || {};
                        var n, o, r, s, a, l, c, d, u, p, f = S.ajaxSetup({}, t), h = f.context || f, v = f.context && (h.nodeType || h.jquery) ? S(h) : S.event, g = S.Deferred(), y = S.Callbacks("once memory"), m = f.statusCode || {}, b = {}, x = {}, T = "canceled", k = {
                            readyState: 0,
                        ...
                        if (g.promise(k),
                        f.url = ((e || f.url || kt.href) + "").replace(Pt, kt.protocol + "//"),
                ...
                g.cors = !!_t && "withCredentials"in _t,
                g.ajax = _t = !!_t,
                S.ajaxTransport((function(e) {
                    var t, n;
                    if (g.cors || _t && !e.crossDomain)
                        return {
                            send: function(o, r) {
                                var s, a = e.xhr();
                ...
                g.createHTMLDocument = ((Xt = w.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
                ...
                S.parseHTML = function(e, t, n) {
                    ...
                    r = !n && [],
                    (o = L.exec(e)) ? [t.createElement(o[1])] : (o = ke([e], t, r),
                ...
                S.each(["top", "left"], (function(e, t) {
                    S.cssHooks[t] = _e(g.pixelPosition, (function(e, n) {
                        if (n)
                            return n = Ue(e, t),
                            We.test(n) ? S(e).position()[t] + "px" : n
                    }
                    ))
                }
                )),
        ...
        ,
        482: ()=>{
            const e = document.querySelectorAll(".accordion-trigger");
            function t(t) {
                const {target: n} = t
                  , i = n.getAttribute("aria-expanded");
                e.forEach((e=>{
                    e.setAttribute("aria-expanded", !1)
                }
                )),
                "false" === i ? n.setAttribute("aria-expanded", !0) : n.setAttribute("aria-expanded", !1)
            }
            e.forEach((e=>{
    ...
    (()=>{
        ...
        const i = ()=>{
            ...
            )(document.getElementById("contractPrffooter").innerText)
        }
        ;
        function o(e, t) {
        ...
        document.querySelector("#contractModulef").addEventListener("click", (function() {
            i(),
            t()("#contractMsgf").fadeIn().delay(3e3).fadeOut()
        }
        )),
        t()("#contractPrf").length && document.querySelector("#contractModule").addEventListener("click", (function() {
            i(),
            t()("#contractMsg").fadeIn().delay(3e3).fadeOut()
        }
        ));
        const r = [];
        function s(e, t, n, i) {
            if (void 0 !== i) {
                ...
                i.once && (o.once = !0),
                i.passive && (o.passive = !0),
                e.addEventListener(t, n, o)
            } else
                e.addEventListener(t, n);
            const o = `${Math.random()}-${+new Date}`;
            return r.push({
                id: o,
                el: e,
                target: t,
        ...
        function a(e) {
            ...
            for (let n = 0, i = r.length; n < i; n++) {
                const i = r[n];
                i.id === e ? i.el.removeEventListener(i.target, i.callback) : t.push(i)
            }
        }
        function l(e, t, n) {
            const i = t.split(" ");
            for (let t = 0; t < i.length; t++)
                void 0 === n ? e.classList.toggle(i[t]) : n ? e.classList.add(i[t]) : e.classList.remove(i[t])
        }
        function c(e, t={}) {
            ...
            t.attr)
                for (let e = 0, i = t.attr.length; e < i; e++) {
                    const i = t.attr[e];
        ...
        function d(e={}) {
            ...
            let a, l = !1, d = !1, u = 0, p = !1, f = i.innerHTML, h = 0, v = [], g = 0;
            const y = [s(window, "resize", (function() {
                if (!1 === t.resize)
                    return;
                const e = r.width
                  , n = r.height
                ...
                if (r.width = i,
                r.height = o,
                "string" == typeof t.resize)
                    return "w" === t.resize && e !== i || "h" === t.resize && n !== o ? void m() : void 0;
                m()
            }
            ...
            function m() {
                ...
                v = [],
                i.innerHTML = "",
                t.useParentStyles && (i.style.position = "relative",
                i.style.width = "100%",
                i.style.overflow = "hidden",
                i.style.whiteSpace = "nowrap");
                const e = w();
                g = e.clientWidth,
                g <= 0 && (g = window.innerWidth),
                g < i.clientWidth && (h = Math.ceil((i.clientWidth + g) / g)),
                h < t.minQuantity && (h = t.minQuantity);
                for (let e = 1; e < h; e += 1)
                    w(!0);
                k(),
                function() {
                    ...
                    a = new MutationObserver((e=>{
                        for (const t of e)
                            "childList" === t.type && (f = i.innerHTML,
                            m())
                    }
                    )),
                    a.observe(i, e)
            ...
            function w(e=!1) {
                const n = c("div", {
                    class: "node-marquee__el",
                    html: `${t.prependWhitespace ? "&nbsp;" : ""}${f}`
                });
                return e && (n.style.position = "absolute",
                n.style.top = "0",
                n.style.left = "0"),
            ...
            function x() {
                ...
                const e = [];
                for (let t = 0; t < h; t += 1)
                    e.push(v[t].clientWidth);
                g = Math.max(...e)
            }
            function T() {
                d && (p = window.requestAnimationFrame(T)),
                k()
            }
            function k(e=t.speed) {
                u -= e;
                const n = g * (h - 1);
                for (let e = 0; e < h; e += 1) {
                    const t = v[e]
                      , i = S(-g, n, u + g * e);
                    t.style.transform = `matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0, ${i}, 0, 0,1)`
                }
            }
            function S(e, t, n) {
                const i = t - e;
        ...
        t()("#nft-slider").slick({
            ...
            autoplay: !0,
            autoplaySpeed: 2e3,
            appendDots: t()(".slick-slider-dots")
        }),
        t()("#success-st").slick({
            infinite: !0,
            prevArrow: !1,
        ...
        d({
            parent: "#projarch-right",
            speed: 1
        }),
        d({
            parent: "#projarch-left",
            speed: -1
        }),
        d({
            parent: "#props-right",
        ...
        t()("#button").click((function() {
            ...
            0 == u ? (document.getElementById("player").play(),
            u = !0,
            t()(this).text("stop sound")) : (document.getElementById("player").pause(),
            u = !1,
            t()(this).text("restart sound"))
        }
        )),
        window.onload = function() {
            const e = document.querySelector("#playtrack")
              , t = document.querySelector("audio");
            t.play(),
            t.volume = .5,
            e.addEventListener("click", (()=>{
                t.paused ? (t.play(),
                e.classList.remove("sound-mute")) : (t.pause(),
                e.classList.add("sound-mute"))
            }
            ))
        }
        ,
        t()(".play-pause-btn").on("click", (function() {
            1 == t()(this).attr("data-click") ? (t()(this).attr("data-click", 0),
            t()("#video")[0].pause()) : (t()(this).attr("data-click", 1),
            t()("#video")[0].play())
        }
        ));
        var p = t()(".bg-block1")
        ...
        setInterval((function() {
            var e = p.eq(h);
            p.removeClass("active").eq(h).addClass("active"),
            e.addClass("active"),
            ++h >= p.length && (h = 0);
            var t = f.eq(h);
            f.removeClass("active").eq(h).addClass("active"),
            t.addClass("active"),
            ++h >= f.length && (h = 0)
        }
        ), 200)
